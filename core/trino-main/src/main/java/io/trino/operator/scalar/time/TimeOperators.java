...
import static io.trino.plugin.base.util.DateTimes.SECONDS_PER_MINUTE;
import static io.trino.plugin.base.util.DateTimes.parseTime;
import static io.trino.plugin.base.util.DateTimes.rescaleWithRounding;
import static io.trino.plugin.base.util.DateTimes.round;
import static io.trino.plugin.base.util.DateTimes.scaleFactor;
